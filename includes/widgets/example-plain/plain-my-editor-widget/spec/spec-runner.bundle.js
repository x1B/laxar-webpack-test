...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Released under the MIT license
	 */
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = function (descriptor, axMocks) {
	   'use strict';
	   ...
	   describe('The my-editor-widget', function () {
	      ...
	      describe('upon entry navigation', function () {
	         ...
	         it('publishes the initial state of its document resource', function () {
	            expect(axMocks.widget.axEventBus.publish).toHaveBeenCalledWith('didReplace.myDocument', jasmine.any(Object));
	         });
	         ...
	         describe('after the document title was edited', function () {
	            ...
	            it('publishes the corresponding update to the document resource', function () {
	               expect(axMocks.widget.axEventBus.publish).toHaveBeenCalledWith('didUpdate.myDocument', {
	                  resource: 'myDocument',
	                  patches: [{ op: 'replace', path: '/htmlTitle', value: 'Hey!' }]
	               });
	            });
	         });
	         ...
	         describe('after the document text was edited', function () {
	            ...
	            it('publishes the corresponding update to the document resource', function () {
	               expect(axMocks.widget.axEventBus.publish).toHaveBeenCalledWith('didUpdate.myDocument', {
	                  resource: 'myDocument',
	                  patches: [{ op: 'replace', path: '/htmlText', value: 'Ho!' }]
	               });
	            });
	         });
	      });
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @module laxar-mocks
	 */
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(4), __webpack_require__(44), __webpack_require__(45), __webpack_require__(47), __webpack_require__(48)], __WEBPACK_AMD_DEFINE_RESULT__ = function (ax, helpers, widgetSpecInitializer, jasmineBoot) {
	   'use strict';
	   ...
	   var widget = {
	      ...
	      load: function load(done) {
	         ...
	         widgetPrivateApi.load().catch(handleErrorForJasmine).then(done);
	      },
	   ...
	   var jasmineRunner = jasmineBoot.create(null);
	   var specContextLoaded = new Promise(function (resolve, reject) {
	      axMocks.runSpec = function (specConf, jasmineEnv) {
	         ...
	         // const specBase = path.relative( specConf.path, specUrl );
	         // const specPrefix = specBase[0] === '.' ? '' : './';
	         ...
	         // loaded.
	         // :TODO: load angular-mocks in widget spec
	   ...
	   function createSetupForWidget(widgetDescriptor, optionalOptions) {
	      ...
	      return function (done) {
	         ...
	         specContextLoaded.then(function (specContext) {
	            specContext.eventBusTick = eventBusTick;
	            specContext.eventBus = axMocks.eventBus;
	            specContext.options = options;
	            return widgetSpecInitializer.createSetupForWidget(specContext, axMocks.widget, widgetPrivateApi, widgetDescriptor);
	         }).catch(handleErrorForJasmine).then(done);
	      };
	   }
	   ...
	   function triggerStartupEvents(optionalEvents) {
	      ...
	      Object.keys(defaultEvents).sort(function (eventNameA, eventNameB) {
	         ...
	         Object.keys(event.subtopics).forEach(function (topicRemainder) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _event_bus = __webpack_require__(10);
	
	var eventBus = _interopRequireWildcard(_event_bus);
	
	var _file_resource_provider = __webpack_require__(11);
	...
	var _widget_loader = __webpack_require__(15);
	...
	var _fn = __webpack_require__(23);
	...
	var _controls_service = __webpack_require__(27);
	
	var controlsService = _interopRequireWildcard(_controls_service);
	
	var _theme_manager = __webpack_require__(36);
	
	var themeManager = _interopRequireWildcard(_theme_manager);
	
	var _plain_adapter = __webpack_require__(43);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _console_channel = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _features_provider = __webpack_require__(16);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jjv = __webpack_require__(18);
	
	var _jjv2 = _interopRequireDefault(_jjv);
	
	var _jjve = __webpack_require__(20);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _flow_service = __webpack_require__(28);
	
	var _file_resource_provider = __webpack_require__(11);
	
	var _heartbeat = __webpack_require__(32);
	
	var _page_service = __webpack_require__(33);
	
	var _theme_manager = __webpack_require__(36);
	
	var _locale_event_manager = __webpack_require__(37);
	
	var _visibility_event_manager = __webpack_require__(38);
	
	var _css_loader = __webpack_require__(39);
	
	var _layout_loader = __webpack_require__(40);
	
	var _page_loader = __webpack_require__(41);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _area_helper = __webpack_require__(34);
	
	var _layout_widget_adapter = __webpack_require__(35);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * http://laxarjs.org/license
	 */
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, __webpack_require__(4), __webpack_require__(44), __webpack_require__(46)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, ax, helpers, http) {
	   'use strict';
	
	   var path = ax._tooling.path;
	
	   function createSetupForWidget(specContext, widgetInfo, widgetPrivateApi, widgetDescriptor) {
	      return loadWidget(specContext, widgetDescriptor).then(setupWidgetInfo.bind(null, specContext, widgetInfo, widgetPrivateApi, widgetDescriptor));
	   }
	   ...
	   function setupWidgetInfo(specContext, widgetInfo, widgetPrivateApi, widgetDescriptor, basicWidgetConfiguration) {
	      ...
	      var cssLoader = { load: function load() {} };
	      ...
	      widgetPrivateApi.load = function () {
	         ...
	         return ax._tooling.widgetLoader.create(helpers.legacyQ(), {
	            ...
	            onBeforeControllerCreation: function onBeforeControllerCreation(environment, injections) {
	            ...
	            return loadingInfo.templatePromise.then(function (template) {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * http://laxarjs.org/license
	 */
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(4)], __WEBPACK_AMD_DEFINE_RESULT__ = function (ax) {
	   'use strict';
	   ...
	   function getJson(url, optionalHeaders) {
	      ...
	      return get(url, headers).then(function (response) {
